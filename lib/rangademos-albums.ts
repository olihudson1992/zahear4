...
export const rangaDemosAlbums: Album[] = [
  {
    ...
    tracks: [
      ...
      { url: "https://rangatracks.b-cdn.net/mwamwa/Rowan.mp3",                                 name: "Rowan" },
      { url: "https://rangatracks.b-cdn.net/mwamwa/Fortune.mp3",                               name: "Fortune" },
      ...
      { url: "https://rangatracks.b-cdn.net/mwamwa/Pultiare.mp3",                              name: "Pultiare" },
