...
export default function WebPlayer() {
  ...
  return (
    <div className={`min-h-screen flex transition-all duration-1000 ${bgColor} ${textColor} relative overflow-hidden`}>
      <audio ref={audioRef} />
      ...
      <div className="w-80 bg-black/20 backdrop-blur-sm p-6 border-r border-white/10">
        <h2 className="text-4xl font-black tracking-[0.3em] uppercase mb-6 text-white transform -skew-x-12 text-shadow-2xl font-mono">
          D E M O E S
        </h2>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        <div className="text-center space-y-12 max-w-2xl">
          {currentTrack && (
            <div className="space-y-6">
              ...
              <h1
                className={`text-6xl md:text-8xl font-bold text-center animate-pulse leading-tight text-balance transition-opacity duration-300 ${isFading ? "opacity-30" : "opacity-100"}`}
              >
          ...
          <div className="space-y-6">
            <div className="flex justify-center">
              <Button
                ...
                size="lg"
                className="w-24 h-24 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/20 transition-all duration-200 hover:scale-105"
              >
          ...
          <div className="pt-12">
            ...
            {showContact && (
              <div className="mt-4 p-4 rounded-lg bg-black/20 backdrop-blur-sm border border-white/10">
                <p className="text-lg text-white/90">oliver.david.hudson@gmail.com</p>
                <p className="text-sm text-white mt-2">all tracks produced by Ranga ready for demonstration</p>
              </div>
            )}
          </div>
        </div>
        ...
        {/* Footer Section */}
        <div className="mt-16 max-w-4xl mx-auto text-center space-y-6 px-4">
          <div className="text-2xl md:text-3xl text-white font-bold mb-8">thanks for listening :) 😊</div>

          <div className="text-xl md:text-2xl text-white font-semibold mb-6">
            if you like anything get in touch yo. i'm at{" "}
            <a href="mailto:oli.ranga.tunes@gmail.com" className="underline hover:text-white/80">
              oli.ranga.tunes@gmail.com
            </a>
          </div>

          <div className="text-base md:text-lg text-white leading-relaxed space-y-4 max-w-3xl mx-auto">
            <p>
